...
public struct DailyForecast: Codable, WeatherConvertible {
    ...
    public init(from decoder: Decoder) throws {
        ...
        dailyTemperature = try values.decode(DailyTemperature.self,
                                             forKey: .dailyTemperature)
        dailyFeelsLike   = try values.decode(DailyTemperature.self,
        ...
        dt         = try values.decode(TimeInterval.self, forKey: .dt)
...
extension DailyForecast {
    ...
    struct DailyTemperature: Codable {
        ...
        init(from decoder: Decoder) throws {
            ...
            let minValue = try values.decodeIfPresent(Double.self, forKey: .min)
            let maxValue = try values.decodeIfPresent(Double.self, forKey: .max)
            ...
            min = minValue == nil ? .zero : Temperature(value: minValue!)
            max = maxValue == nil ? .zero : Temperature(value: maxValue!)
        }
